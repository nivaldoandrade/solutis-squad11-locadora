...
public interface CarrinhoController {
    ...
    @Operation(
            ...
            responses = {
                    @ApiResponse(
                            ...
                            content = @Content(
                                    schema = @Schema(implementation = CarrinhoDTO.class)
                            )
                    ),
    ...
    @GetMapping("/{id}")
    ResponseEntity<CarrinhoDTO> show(
    ...
    @PostMapping
    ResponseEntity<CarrinhoDTO> create(
    ...
    ResponseEntity<CarrinhoDTO> addAndUpdateCarro(
